...
const DesktopPage = () => (
  ...
  <div class="siteWrapper">
    ...
    <TitledImage 
        ...
        body="desktopTextBody"
        buttonClass="buttondesktop"
        titledImageHeight="65vh"
        titledImageRow="--row1-h1"
        titleText="Paving the way for Industry 4.0"
        bodyText="Guided assembly and real-time Machine Verification in one simple package"
        imageTag={arheadset}
        imageAlt="testingggg"
        imageHeight="320vh"
        />
