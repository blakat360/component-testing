...
function ArticleSlider(props) {
    let sliderheight1 = props.articleSliderHeight;
    let articleSliderRowNo = props.articleSliderRow;
    document.documentElement.style.setProperty(String(articleSliderRowNo), sliderheight1);
    document.documentElement.style.setProperty("--articleSliderH1", sliderheight1);
    return(
        <div class="articleSlider">
            ...
            <Carousel class='sliderBlock'>
                <Carousel.Item>
                    ...
                    caroItemClass={props.carouselItemClass}
